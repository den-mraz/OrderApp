package net.denis.orderapp.presentation.ui.adapter.dashboard
...
import net.denis.orderapp.presentation.ui.fragment.dashboard.DashboardFragmentDirections
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DashboardViewHolder {
        return DashboardViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.item_layout_dashboard,
                parent,
                false
            )
        )
